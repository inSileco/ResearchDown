...
0. Open a new `.Rmd` document
1. Run `data(diamonds)` within a chunk
2. Add the following text and fill it with inline code: `
...
# `r icon::fa("rocket")` Deploy `rmarkdown` HTML
