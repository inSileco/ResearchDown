...
- Example: `https://github.com/SteveViss/firstOnlineDocument.git`
...
- We want to create a `.Rmd`, which produces a `.html` file in the RStudio project folder.
