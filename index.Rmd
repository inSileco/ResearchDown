...
```{r, echo=FALSE}
countdown::countdown(minutes = 12, seconds = 0)
```
...
`r icon::fa("arrow-circle-right")` Impress your director | Turn into a geek | Expose your skills on the web 
...
3. Connect the RStudio project to Github
4. Send HTML files on the Github repository with RStudio
